...
namespace TMG.LD51
{
    public static class MathUtilities
    {
        ...
        public static quaternion SetRotationTowards(quaternion from, quaternion to, float maxDegreesDelta)
        {
            var num = Angle(from, to);
            return math.slerp(from, to, math.min(1f, maxDegreesDelta / num));
        }
